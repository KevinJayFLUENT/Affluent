  ...
  return [
    ...
    // ───────────────────── Polite deflector ("ask me next year") ─────────────────────
    {
      ...
      details: {
        ...
        address: "Cambridge, United Kingdom", recurringRevenue: "$6.7M ARR", revenues: "$7.8M",
        ...
        scraping: {
          ...
          hqCity: "Cambridge", hqCountry: "GB", successionScore: 61, acquisitionFitScore: 76, acquisitionFitBand: "high",
    ...
    // Curious founder, early dialogue
    {
      ...
      brand: { light: true, initials: "KC", mark: "kestrel" },
    ...
    // Split co-founders
    {
      ...
      location: "Toronto, ON",
      brand: { light: true, initials: "OS", mark: "orbita" },
      ...
      activity: [
        ...
        { date: "2026-05-09", rep: "Nathan Lim", type: "meeting", direction: "out", subject: "M1 - Coffee, Toronto", sentiment: "positive", note: "No deal talk. Carlos venting about the grind; Dre building an AI feature he thinks doubles the value." },
      ],
      details: {
      ...
      cachedAnalysis: {
        ...
        revivalRadar: null,
        recommendedAction: { title: "CTO-to-CTO bridge — recruit Dre's respect, not his signature", rationale: "The only vote we don't have has never met a technical peer from our side. Zero deal content; pure architecture talk.", artifactType: "task", artifact: "Intro our platform architect to Dre via the MSP DevOps meetup both attend (Sept, Toronto). Topic: multi-tenant billing architecture — Dre's known pain. No corp dev present, no deal mention. Goal: Dre stops picturing acquirers as suits." },
      },
    },
    ...
    // Distressed-channel seller
    {
      ...
      brand: { light: true, initials: "BL", mark: "brightspan" },
    ...
    // Minority-investor liquidity push
    {
      ...
      location: "Phoenix, AZ",
      brand: { light: true, initials: "CF", mark: "cobalt" },
